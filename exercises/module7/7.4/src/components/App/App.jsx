...
const NavBar = () => {
  ...
  return (
    <nav>
      <Button color="default" variant="filled" onClick={() => navigate("/")}>Home</Button>
      <Button color="default" variant="filled" onClick={() => navigate("/cinema")}>cinema</Button>
      <Button color="default" variant="filled" onClick={() => navigate("/movies")}> movies</Button>
      <Button color="default" variant="filled" onClick={() => navigate("/add-movie")}>Add a movie</Button>
    </nav>
  );
};
